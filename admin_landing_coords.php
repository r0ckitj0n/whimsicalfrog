...
$notice = null;
$error = null;
$coords = [ 'top' => 411, 'left' => 601, 'width' => 125, 'height' => 77 ];
...
try {
    ...
    if (!$row) {
        $row = Database::queryOne("SELECT coordinates FROM room_maps WHERE room_number = 'A' ORDER BY updated_at DESC, created_at DESC LIMIT 1", []);
    }
