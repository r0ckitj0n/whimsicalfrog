...
// Lightweight DB connectivity smoke test callable from browser or curl.
// Usage examples:
//   GET /api/db_smoke_test.php?target=current&admin_token=whimsical_admin_2024
//   GET /api/db_smoke_test.php?target=live&admin_token=whimsical_admin_2024
