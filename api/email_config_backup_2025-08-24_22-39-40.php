...
define('FROM_NAME', 'Whimsical Frog');
define('ADMIN_EMAIL', 'jon@netman.us'); // Admin notification email
...
// SMTP password is stored in the secret store; leave blank here on purpose
