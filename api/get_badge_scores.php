...
function calculateBadgeScores($item, $db) {
    ...
    if ($retailPrice > 100) $qualityFactors += 20;
    elseif ($retailPrice > 50) $qualityFactors += 10;
    elseif ($retailPrice > 25) $qualityFactors += 5;
    ...
    try {
        ...
        if ($recentSales >= 10) $scores['trending'] = 100;
        elseif ($recentSales >= 5) $scores['trending'] = 80;
        elseif ($recentSales >= 3) $scores['trending'] = 60;
        elseif ($recentSales >= 1) $scores['trending'] = 40;
        else $scores['trending'] = 20;
    } catch (Exception $e) {
    ...
    try {
        ...
        if ($totalSold >= 50) $scores['bestseller'] = 100;
        elseif ($totalSold >= 20) $scores['bestseller'] = 80;
        elseif ($totalSold >= 10) $scores['bestseller'] = 60;
        elseif ($totalSold >= 5) $scores['bestseller'] = 40;
        else $scores['bestseller'] = 20;
    } catch (Exception $e) {
