...
try {
    ...
    // Get recent activity - check what.created_at column exists
    $lastOrderDate = null;
    try {
        // Try different possible.created_at column names
        $possibleDateColumns = ['created_at', 'date_created', 'order.created_at', 'timestamp'];
