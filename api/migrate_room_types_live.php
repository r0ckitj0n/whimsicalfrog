<?php
// Migration script for LIVE SERVER to update room_maps table from room names to room numbers
// This maintains the generic infrastructure while preserving existing room data

header('Content-Type: application/json');

// IONOS Live server database configuration
...
try {
    ...
    echo json_encode([
        'success' => true,
        'message' => "LIVE SERVER Migration completed successfully. Updated {$updateCount} room_maps entries.",
        'details' => $messages,
    ...
    echo json_encode([
        'success' => false,
        'message' => 'LIVE SERVER Migration failed: ' . $e->getMessage()
    ]);
}
?> 