...
(function() {
        ...
        try {
            ...
            setTimeout(() => {
                if (typeof window.showDetailedModalComponent !== 'undefined') {
                    ...
                    if (modal) {
                        // Use CSS classes only to control visibility/display
                        ...
                        window.scrollbarMonitor = setInterval(() => {
                            // No inline style writes; rely on CSS tied to .modal-open
                        }, 100);
                    }
                }
            }, 50);
    ...
    function closeGlobalItemModal() {
        ...
        if (modal) {
            ...
            // No inline style resets; CSS should revert via class removal
        }
