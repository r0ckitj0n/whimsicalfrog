...
const EnhancedRoomSettings = {
    ...
    async loadRoomSettings() {
        try {
            ...
            this.modal.querySelector('.loading-message').innerHTML = '<p class="text-error">Error loading settings. Please try again.</p>';
        }
    },
    ...
    showNotification(message, type) {
        ...
        notification.className = `wf-toast ${type}`;
...
function applyDoorCoordinates() {
    ...
    MainRoomConfig.doorCoordinates.forEach((coord, index) => {
        ...
        if (door) {
            ...
            // Use CSS custom properties and a helper class
