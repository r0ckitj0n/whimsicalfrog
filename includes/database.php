    ...
    private function __construct() {
        ...
        try {
            ...
            try {
                ...
                try { $this->pdo->exec("SET NAMES utf8mb4 COLLATE " . $targetCollation); }
                catch (\Throwable $e2) { try { $this->pdo->exec("SET NAMES utf8mb4 COLLATE utf8mb4_unicode_ci"); } catch (\Throwable $e3) {} }
                try { $this->pdo->exec("SET collation_connection = " . $targetCollation); }
                catch (\Throwable $e4) { try { $this->pdo->exec("SET collation_connection = utf8mb4_unicode_ci"); } catch (\Throwable $e5) {} }
