...
class ErrorLogger
{
     ...
     */
    public static function logError($errorType, $message, $context = [], $user_id = null)
    {
        if (!self::$pdo) {
            try {
                self::$pdo = Database::getInstance();
        ...
        try {
            ...
            if (!$user_id && session_status() === PHP_SESSION_ACTIVE && isset($_SESSION['user'])) {
     ...
     */
    public static function logCustomError($type, $message, $details = [], $user_id = null)
    {
        ...
        return self::logError($type, $message, $context, $user_id);
    }
     ...
     * Log API errors
     */
    public static function logApiError($endpoint, $error, $requestData = [], $user_id = null)
    {
        $context = [
            'endpoint' => $endpoint,
        ...
        return self::logError('API_ERROR', $error, $context, $user_id);
    }
...
/*
function logCustomError($type, $message, $details = [], $user_id = null)
{
    return ErrorLogger::logCustomError($type, $message, $details, $user_id);
}
...
function logApiError($endpoint, $error, $requestData = [], $user_id = null)
{
    return ErrorLogger::logApiError($endpoint, $error, $requestData, $user_id);
}
*/
