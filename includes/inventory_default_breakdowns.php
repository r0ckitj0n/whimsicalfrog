...
/**
 * Seed explanatory manual breakdown rows for a new inventory item.
 *
 * The item prices submitted to add_inventory are authoritative for the save.
 * Factor-editing endpoints sync factors back to items when factors are edited;
 * initial seeding must not overwrite freshly submitted prices with defaults.
 */
