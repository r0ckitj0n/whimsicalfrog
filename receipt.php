...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <div class="flex justify-end mt-4 mb-6">
        <div class="border-t-2 border-gray-300 pt-2">
            <span class="text-red-600 text-xl font-bold">Total: $<?= $total ?></span>
        </div>
    </div>

    <?php if ($pending): ?>
        <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 text-sm text-center" role="alert">
