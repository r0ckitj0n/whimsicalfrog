...
try {
    ...
    if (!tableExists('categories')) throw new RuntimeException('Table categories does not exist');
    if (!tableExists('items')) throw new RuntimeException('Table items does not exist');
    if (!tableExists('room_category_assignments')) throw new RuntimeException('Table room_category_assignments does not exist');
