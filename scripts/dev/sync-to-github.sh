...
#
# Usage:
#   scripts/dev/sync-to-github.sh --repo https://github.com/<user>/<repo>.git [--branch main] [--remote origin] [--update-remote] [--no-verify]
#   scripts/dev/sync-to-github.sh --repo <user>/<repo> --create-repo [--private|--public] [--branch main] [--remote origin] [--no-verify]
#
# Notes:
