...
const allowlist = [
  ...
  { fileRe: /(^|\/)src\/core\/ApiClient\.ts$/, names: ['fetch'] },
  { fileRe: /(^|\/)src\/core\/ApiClient\.ts$/, names: ['XMLHttpRequest'] },
  ...
  // Analytics hook uses beacon fallback for unload-safe tracking
  { fileRe: /(^|\/)src\/hooks\/useAnalytics\.ts$/, names: ['sendBeacon'] },
];
