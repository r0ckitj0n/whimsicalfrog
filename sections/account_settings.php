<?php
// Account Settings (migrated from admin/account_settings.php)
...
// Require a logged-in user (admin area router is used; adjust if this should be customer-only)
if (!AuthHelper::isLoggedIn()) {
    ...
    if ($__wf_included_layout) { include __DIR__ . '/../partials/footer.php'; }
    exit;
}
