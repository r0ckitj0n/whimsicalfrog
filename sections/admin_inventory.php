...
function testModalVisibility() {
    ...
    // Check if modal is actually in the viewport
    ...
    console.log("🚨 Modal forced to be super visible with red background and yellow border");
    
    setTimeout(() => {
        const newRect = modal.getBoundingClientRect();
        console.log("📍 New modal position:", newRect);
...
function addTestButton() {
    ...
    testBtn.innerHTML = "🧪 Test Modal Visibility";
    testBtn.style.cssText = `
        ...
        font-weight: bold;
    `;
    testBtn.onclick = testModalVisibility;
    document.body.appendChild(testBtn);
    console.log("🧪 Test button added to page");
}

// Add test when page loads
