    ...
    <div class="settings-grid">
      ...
      <section class="settings-section content-section card-theme-blue">
        ...
        <div class="section-content">
          ...
          <button type="button" class="admin-settings-button btn-primary btn-full-width" data-action="open-attributes" onclick="try{ if (showModal('attributesModal')) { populateAttributes(); } }catch(e){} return false;">Gender, Size &amp; Color Management</button>
