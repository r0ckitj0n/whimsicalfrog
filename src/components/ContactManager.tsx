...
export const ContactManager: React.FC<ContactManagerProps> = ({ businessData }) => {
    ...
    return (
        <div className="wf-contact-page-frame px-4 py-0">
            <div className="wf-contact-columns">
                <aside className="wf-contact-details-column">
                    {publicDetails && (
                        <section className="wf-contact-trust">
                            <h2 className="wf-contact-trust__title">Business Contact Details</h2>
                            <div className="wf-contact-trust__body">
                                ...
                                {publicDetails.email && (
                                    <p><strong>Email:</strong> <a href={`mailto:${publicDetails.email}`}>{publicDetails.email}</a></p>
                                )}
                                {publicDetails.phone && (
                                    <p><strong>Phone:</strong> <a href={`tel:${publicDetails.phone.replace(/[^\d+]/g, '')}`}>{publicDetails.phone}</a></p>
                                )}
                                ...
                                {publicDetails.address && (
                                    <p className="wf-contact-trust__address"><strong>Address:</strong> {publicDetails.address}</p>
                                )}
                            </div>
                        </section>
                    )}
                ...
                <div className="wf-contact-form-column">
                    <ContactForm
                        formData={formData}
