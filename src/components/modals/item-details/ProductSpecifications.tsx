...
export const ProductSpecifications: React.FC<ProductSpecificationsProps> = ({ item }) => {
    ...
    return (
        <div style={{ marginTop: '40px' }}>
            ...
            {isDetailsOpen && (
                <div className="specs-panel" style={{ marginTop: '16px', padding: '32px', backgroundColor: '#f9fafb', borderRadius: '20px', border: '1px solid #f3f4f6', fontSize: '15px', color: '#4b5563', boxShadow: 'inset 0 2px 8px rgba(0,0,0,0.03)' }}>
                    <div className="specs-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px', marginBottom: '32px' }}>
                        <div>
