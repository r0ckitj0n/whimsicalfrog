...
(function() {
    ...
    function refreshSizeLabels(modal) {
        ...
        Array.from(sizeSelect.options).forEach((opt) => {
            ...
            let stock = agg ? Number(agg.stock || 0) : sumStockForSize(sizeCode, { colorId: selectedColorId });
            ...
            if (!btn.dataset.cartHandlerBound) {
                btn.addEventListener('click', async (e) => {
                    ...
                    try {
                        ...
                        try { window.openCartModal && window.openCartModal(); } catch(_) {}
    ...
    function quickAddToCart(item) {
        // Implementation omitted for brevity in backup
    }
