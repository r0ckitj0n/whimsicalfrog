...
INSERT INTO `inventory` VALUES ('I001','TS001','Whimsical Frog T-Shirt','Order your whimsical frog t-shirt today!','WF-TS-001',0,10,9.00,40.00,'images/products/TS001A.png'),('I002','TU001','Frog Painter Tumbler','Painter frog on a tumbler. How silly!','WF-TU-001',36,5,10.02,30.00,'images/products/TU001A.png'),('I003','AW001','Frog Painter','Get the frog painter printed on a sheet of photo paper','WF-AR-001',16,7,4.00,43.00,'images/products/AW001A.png'),('I004','GN001','Window Wrap, Small Business','Size: 3x4 ft','WF-WW-001',0,3,45.00,289.99,'images/products/GN001A.png'),('I005','TU002','Frog Tumbler','Get the whimsical frog on a 24oz tumbler','WF-TU-002',0,6,7.50,30.00,'images/products/TU002A.png'),('I006','MG001','Frog Mug','Coffee mug with whimsical frog on the side!','WF-SU-002',0,5,10.00,34.99,'images/products/MG001A.png'),('I007','TU002','Frog Tumbler 30oz','30oz Tumbler with Whimsical Frog on it!','WF-TU-003',0,5,8.00,34.99,'images/products/TU002A.png'),('I008','TS002','Clown Frog','Order your clown frog t-shirt today!','WF-TS-002',0,5,10.00,40.00,'images/products/TS002A.webp');
...
CREATE TABLE `room_maps` (
  ...
  KEY `idx_room_active` (`room_type`,`is_active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `room_maps` WRITE;
/*!40000 ALTER TABLE `room_maps` DISABLE KEYS */;
/*!40000 ALTER TABLE `room_maps` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-06-15 18:58:37
